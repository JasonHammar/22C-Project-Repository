public class VideoGames  implements Comparable<VideoGames>{
	 ...
	 * @param gross    the amount grossed over the lifetime of the Video Game, given in
	 *                 Millions of dollars
	 */
	...
	/**
	 * Compares two Video Game objects to determine ordering Returns 0 if the two items
	 * are equal Return -1 if this Video Game's title comes alphabetically before the
	 * other Video Game's title. Returns 1 if the other Video Game's title comes
	 * alphabetically before this Video Game's title If the two Video Game's titles are the
	 * same, will differentiate by director's name (alphabetical comparison)
	 *
	 * @param the other Video Game object to compare to this
	 * @return 0 (same Video Game), -1 (this Video Game ordered first) or 1 (the other Video Game
	 *         ordered first)
	 */
	//@Override
	...
	/**
	 * Returns a consistent hash code for each Video Game by summing the Unicode values
